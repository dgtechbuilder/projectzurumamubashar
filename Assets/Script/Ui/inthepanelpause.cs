...
public class inthepanelpause : MonoBehaviour {
    ...
    // Set display in main menu bar
    public GameObject panelmain; // Main menu panel
    public GameObject btnbuyvan; // Buy skateboard panel
    public GameObject btnsetinginthemain; // Open settings button in main menu
    public GameObject btnopenshopinthemain; // Open shop button in main menu
    public GameObject tabplaymain;  // Hidden tab play button
