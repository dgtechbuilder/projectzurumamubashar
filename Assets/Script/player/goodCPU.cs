...
public class goodCPU : MonoBehaviour
{
   ...
   public void GetStartrotay(bool value)
    ...
    {
        if (coll.gameObject.tag == "coin"|| coll.gameObject.tag == "bay"|| coll.gameObject.tag == "baycao" || coll.gameObject.tag == "iteamgiay" || coll.gameObject.tag == "hopqua" || coll.gameObject.tag == "key" || coll.gameObject.tag == "namcham"|| coll.gameObject.tag == "van" || coll.gameObject.tag == "sword")
        {
